...
class DrawImplantInteractorStyle : public vtkInteractorStyleTrackballCamera
{
public:
	static DrawImplantInteractorStyle* New() { return new DrawImplantInteractorStyle(); };
	DrawImplantInteractorStyle();
...
private:
	...
	int m_lastClickedSplinePtID = 0; // for update Implant in time
